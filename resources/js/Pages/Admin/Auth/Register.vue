            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="name" v-model="form.name" name="name" type="text" autocomplete="name" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <!--                            <Link href="#" class="font-medium text-indigo-600 hover:text-indigo-500"> Login </Link>-->
                        </div>
                    </div>
                    ...
                    <div>
                        <Link :href="route('admin.login')" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Login</Link>
                    </div>
                </form>
...
export default {
    ...
    methods:{
        submit(){
            ...
            this.$inertia.post('/admin/register', this.form)
        }
    },
    components:{
        Link,
